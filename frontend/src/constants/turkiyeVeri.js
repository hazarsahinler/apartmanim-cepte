// Türkiye 81 İl ve İlçe Verileri
export const turkiyeVeri = {
  ...
  "Bolu": ["Dörtdivan", "Gerede", "Göynük", "Kıbrışçık", "Mengen", "Merkez", "Mudurnu", "Seben", "Yeniçağa"],
  ...
  "Kahramanmaraş": ["Afşin", "Andırın", "Çağlayancerit", "Dulkadiroğlu", "Elbistan", "Ekinözü", "Göksun", "Nurhak", "Onikişubat", "Pazarcık", "Türkoğlu"],
...
// İllerin listesi
export const iller = Object.keys(turkiyeVeri).sort();

// Belirli bir ilin ilçelerini getiren fonksiyon
export const getIlceler = (il) => {
  return turkiyeVeri[il] || [];
};