...
const YoneticiKayit = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 py-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">Yönetici Kayıt</p>
          </div>
